...
class AppCouleur {
  ...
  static const Color droitier = Color(0xFF6882DA);
  Color principal = const Color(0xE636C4FF);
  ...
  static const Color gaucher = Color(0xFFE14040);
  ...
  AppCouleur(){
    ...
    if(SchedulerBinding.instance.platformDispatcher.platformBrightness==Brightness.dark){
      ...
      indyBlue = const Color(0xFF00DCFF);
